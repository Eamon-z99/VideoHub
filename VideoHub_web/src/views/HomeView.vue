  ...
  <div class="cili_header">
    ...
    <div class="header_channel">
      <div class="channel-icons">
        <li class="icons">
          <div class="dynamic">
            <div class="dynamic-bg"><img src="../assets/动态.png" class="dynamic-img" /></div>
            <span>动态</span>
          </div>
        </li>
        <li class="icons">
          <div class="popular">
            <div class="popular-bg"><img src="../assets/热门.png" class="popular-img" /></div>
            <span>热门</span>
          </div>
        </li>
      </div>
      ...
      <div class="channel-container">
        ...
        <div class="channel-right">
          <div class="grid-containerb">
            <a href="#" class="grid-itemb"><img src="../assets/channel/zhuanlan.png" class="grid-itemb-img">专栏</a>
            <a href="#" class="grid-itemb"><img src="../assets/channel/huodong.png" class="grid-itemb-img">活动</a>
            <a href="#" class="grid-itemb"><img src="../assets/channel/社区中心.png" class="grid-itemb-img">社区中心</a>
            <a href="#" class="grid-itemb"><img src="../assets/channel/直播.png" class="grid-itemb-img">直播</a>
